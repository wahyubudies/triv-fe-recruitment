         ...
         <Container className="flex justify-between items-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
               ...
               <div className="flex flex-col justify-center">
                  ...
                  <button className="bg-blue-500 hover:bg-blue-600 text-white py-2 sm:py-3 lg:py-4 px-4 sm:px-6 lg:px-8 text-base sm:text-lg lg:text-xl font-medium w-fit flex items-center mb-3 sm:mb-4 lg:mb-6 transition-colors">
